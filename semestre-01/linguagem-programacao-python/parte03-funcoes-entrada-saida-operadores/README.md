...
Solicita o valor de uma conta e a porcentagem de gorjeta desejada, calculando o valor da gorjeta e o total final.
...
\*\*Expressão:\*\* `s += a + b\*\*(c-d)/e \* f`, com `a=5, b=4, c=9, d=7, e=1, f=2, s=10`
