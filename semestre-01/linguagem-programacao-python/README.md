...
| [Linguagem de Programação (Python)](./semestre-01/linguagem-programacao-python) | 🟡 Em andamento |
...
`C#` `SQL Server` `Entity Framework` `APIs` `Redes` `Hardware` `Python` `Portugol`
